...
public class Flight : MonoBehaviour
{
	...
	void FixedUpdate()
	{
		...
		if(pitch == 0.0f && roll == 0.0f && yaw == 0.0f && my_transform.rotation != look_to)
		{
	...
	{
		Vector3 move_camera_to = my_transform.position - my_transform.forward * 20.0f + Vector3.up * 10.0f;
