...
[System.Serializable]
public class _PlayerPokemonData : ISerializable
{
	...
	public int level;
	public _Pokemon.Genders gender;
	public _Pokemon.Natures nature;
	public int curHP;
	public int hpEV;
	public int atkEV;
	public int defEV;
	...
	public _PlayerPokemonData()
	{

	}
	
	public _PlayerPokemonData(bool newIsCaptured, string newPokemonName, string newNickName, bool newIsFromTrade,
	                          int newLevel, _Pokemon.Genders newSex, _Pokemon.Natures newNature, int newCurHP, int newHpEV, int newAtkEV, int newDefEV,
	                          ...
	                          int newCurrentXP, _Pokemon.StatusConditions newStatusCondition,
	...
	protected _PlayerPokemonData(SerializationInfo info, StreamingContext context)
	{
		...
		gender = (_Pokemon.Genders)info.GetByte("sex");
		nature = (_Pokemon.Natures)info.GetByte("nature");
		...
		statusCondition = (_Pokemon.StatusConditions)info.GetByte("statusCondition");
