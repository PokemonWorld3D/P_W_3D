...
public class _EmptyPokeBall : MonoBehaviour
{
	...
	public PokeBall.PokeBallTypes thisPokeBallType;
	public _PlayerCharacter thisPlayer;

	private RaycastHit hit;
	private float distanceToGround;
	private _CalculateCapture calculateCaptureScript = new _CalculateCapture();
	...
	void OnCollisionEnter(Collision col)
	{
		...
		{
			_Pokemon thisPokemon = col.gameObject.GetComponent<_Pokemon>();
	...
	private IEnumerator TryToCatch(Collision col)
	{
		...
		if(tryToCapture){
			...
			_Pokemon temp = thisPokemon;
			_PlayerPokemonData dataHolderPokemon = new _PlayerPokemonData(temp.isCaptured, temp.pokemonName, temp.nickName,
