...
[System.Serializable]
public class NEWPlayerPokemonData : ISerializable {
	...
	public NEWPlayerPokemonData(){

	}
	
	public NEWPlayerPokemonData(bool newIsSetup, bool newIsCaptured, string newTrainersName, string newPokemonName, string newNickName, bool newIsFromTrade,
	                            int newLevel,
	                            ...
	                            BasePokemon.NonVolatileStatusConditionList newStatusCondition, List<Move> newMovesToLearn, List<Move> newPokemonsMoves,
	...
	protected NEWPlayerPokemonData(SerializationInfo info, StreamingContext context){
